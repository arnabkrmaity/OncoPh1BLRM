#' @title Combo3BLRMSimDecisionRule Function
#'
#' @description This function performs escalation and decision rule trial simulation 
#'              with triple combination model
#'              
#' 
...
#' 
#'
#' @seealso \code{\link{SingleBLRMSimDecisionRule}}, \code{\link{Combo3BLRMSim}}
#' 
#' 
#' @export
#' 
#' 
Combo3BLRMSimDecisionRule <- function (MaxN,
                                       mnMTD,
                                       mnTOT,
                                       mnTAR,
                                       EWOC,
                                        ...
                                        )
{
  ...
  function(currentRun, Ntot, currentDoseAdm1, currentDoseAdm2,currentDoseAdm3,Doses1, Doses2){


    CDoseAdm1 <- currentDoseAdm1
    CDoseAdm2 <- currentDoseAdm2
    CDoseAdm3 <- currentDoseAdm3
    ...
    totNPAT <- sum(datsummary[, "NPAT"][datsummary[, "DOSEADM1"] ==  CDoseAdm1 & datsummary[, "DOSEADM2"] == CDoseAdm2 & datsummary[, "DOSEADM3"] == CDoseAdm3 & datsummary[, "WEIGHT"] == 1])
    totNTOX <- sum(datsummary[, "NTOX"][datsummary[, "DOSEADM1"] ==  CDoseAdm1 & datsummary[, "DOSEADM2"] == CDoseAdm2 & datsummary[, "DOSEADM3"] == CDoseAdm3 & datsummary[, "WEIGHT"] == 1])
    ...
    return(list(too.toxic = too.toxic, stop.trial = stop.trial,
                is.MTD = is.MTD, DoseAdm1 = DoseAdm1, DoseAdm2 = DoseAdm2, DoseAdm3 = DoseAdm3))
  }
}